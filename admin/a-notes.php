      ...
      if(title==""){
        ...
        if(notes==""){
          ...
          $.post("actions/notes/l-action-addNotes.php",{postTitle:title,postNotes:notes},function(add){
            window.location.replace("a-notes.php");
            $("#msg").html(add);
          });
        }
      }
    ...
    <div id="wrapper">
      ...
      if(isset($_GET['action'])){
          $id = $_GET['id'];
            ...
            $mynotes = $db->query("select * from a_notes where id='$id' ") or die("Can't complete process. Please contact your Administrator.");
...
<div id='msg'></div>
            ...
            <div class="row">
              ...
              echo "
                    <p class='text-right'>
                    <a href='a-notes.php'  class='btn btn-default'>New</a>
          ...
          <div class="panel panel-info">
              ...
              <div class="panel-body">
                  <div class="list-group">
                    <?php
                        $mynotes = $db->query("select * from a_notes where stat=1 order by id desc limit 30") or die("Can't complete process. Please contact your Administrator.");
                        if($mynotes->num_rows!=0)
                        {
                          while($rows=$mynotes->fetch_assoc())
                          {
                            ...
                            echo "<a href='a-notes.php?action=edit&id=$id' class='list-group-item'>
                                $title
