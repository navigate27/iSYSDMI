...
<head>
    ...
    <title>Form wizard (using tabs) - Bootsnipp.com</title>
        ...
        ?>
      <link rel="stylesheet" href="../style/form-wizard.css">
                            ...
                            <label for="snum">Student Number</label>
                              <!-- <div class="input-group">
                                <span class="input-group-addon">
                                  <select id="year" class="selectpicker form-control" data-live-search="true" title="woro">
                                    <option>A</option>
                                    <option>B</option>
                                    <option>C</option>
                                  </select>
                                ...
                                <input type="text" placeholder="S20xx128xxxx" class="form-control" id="form-snum" name="snum" autocomplete="off">
